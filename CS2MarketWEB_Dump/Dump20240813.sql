...
CREATE TABLE `carrinho` (
  ...
  KEY `id_skin` (`id_skin`),
  KEY `fk_usuario` (`iduser`),
  CONSTRAINT `carrinho_ibfk_2` FOREIGN KEY (`id_skin`) REFERENCES `skin` (`idskin`),
  CONSTRAINT `fk_usuario` FOREIGN KEY (`iduser`) REFERENCES `usuarios` (`id`)
...
INSERT INTO `colecao` VALUES (1,'Nao possui'),(2,'Mirage'),(4,'Dust II'),(5,'The Assault Collection'),(6,'Anubis');
...
INSERT INTO `skin` VALUES (14,'Fuinha',3.5,2,4,1),(16,'Asiimov',132.9,9,6,1),(17,'Corintiano',1.52,8,3,5),(19,'Fade',4000,2,5,1),(20,'CaimÃÂ£o',23.19,1,5,4),(21,'Bico de Bunsen',4.5,2,3,2),(22,'Pesadelo',23.09,7,4,1),(24,'Tons de Preto',22,5,4,1),(25,'Steel Delta',15,5,3,6),(26,'Asiimov',200,6,5,1);
...
-- Dump completed on 2024-08-13 17:52:41
