...
CREATE TABLE `avaliacoes` (
  ...
  KEY `id_skin` (`id_skin`),
  CONSTRAINT `avaliacoes_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`idusuarios`),
  CONSTRAINT `avaliacoes_ibfk_2` FOREIGN KEY (`id_skin`) REFERENCES `skin` (`idskin`)
